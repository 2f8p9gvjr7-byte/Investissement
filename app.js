...
function genererFormulaireAv(data) {
  return `
    ...
    <div class="note-fiscale">
      Rachat total simulé à la durée choisie. Les frais sur versement (aussi appelés frais d'entrée) sont prélevés immédiatement sur chaque versement, avant capitalisation : environ 40&nbsp;% des contrats (surtout en ligne) n'en appliquent aucun, un tiers se situent entre 0,1&nbsp;% et 2&nbsp;%, et certains contrats bancaires traditionnels facturent encore 3&nbsp;% à plus de 4&nbsp;%. Ils réduisent le capital réellement investi mais pas la base de calcul du gain taxable (calculé sur le montant versé, frais compris). Avant 8 ans : PFU 30&nbsp;% (12,8&nbsp;% IR + 17,2&nbsp;% PS) sans abattement. Après 8 ans : abattement annuel sur les gains (4&nbsp;600&nbsp;€ pour une personne seule, 9&nbsp;200&nbsp;€ pour un couple), puis 7,5&nbsp;% IR + 17,2&nbsp;% PS (les PS s'appliquent toujours sur la totalité des gains, sans abattement). L'assurance-vie est explicitement exclue de la hausse de CSG de la LFSS 2026 (loi n° 2025-1403, art. 12) : contrairement à la plupart des autres placements financiers, ses PS restent à 17,2&nbsp;%.
